...
namespace Tellurian.Trains.Modules
{
    public struct LocoConfiguration
    {
        ...
        public bool IsLongAddress => ConfigurationVariable29.IsLongAddress();
        public bool IsAnalogOperationEnabled => ConfigurationVariable29.IsAnalogOperationEnabled();
        public bool IsRailComEnabled => ConfigurationVariable29.IsRailComEnabled();
        public bool Is28Or128SpeedSteps => ConfigurationVariable29.Is28Or128SpeedSteps();
        public int LocoAddress { get { return this.LocoAddress(); } set { this.LocoAddress(value); } }
